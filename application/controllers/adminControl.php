    ...
    public function getAllProduct() {
        ...
        foreach ($allProduct as $val) {
            ...
            if ($val->status == "ACTIVE"){
                ...
                $row[] = '<button class="btn detail btn-info" id_p="' . $val->id . '"
                    data-toggle="modal" data-target="#detail-product">Chi tiết</button>';
            } else {
                ...
                $row[] = '<button class="btn detail btn-info" id_p="' . $val->id . '"
                    data-toggle="modal" data-target="#detail-product" disabled>Chi tiết</button>';
            }
