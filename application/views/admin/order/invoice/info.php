...
<div class="card shadow mb-4">
        <div class="card-header">
            <div class="row">
                <h6 class="col-md-6 d-flex align-items-center font-weight-bold text-primary">Tất cả hóa đơn</h6>
                <!-- Table Search -->
                <div class="col-md-6 d-flex justify-content-end form-inline find-input">
                    <input type="text" class="form-control find" 
                    placeholder="Tìm kiếm theo cột..." tb_id="invoice_table">
        ...
        <div class="card-body">
            ...
            <table id="invoice_table" class="display w-100">
                <thead>
                    <tr>
                        <th>STT</th>
...
<script>
    $(document).ready(function() {
        loadPage("#orderPage")
        initTable("#invoice_table", "/admin/getAllInvoice")
    })
</script>